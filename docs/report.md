...
В практически любой организации существуют отделы, характеризуемые названием отдела. В отделах работают сотрудники. Необходимо представить структуру предприятия при помощи этих сущностей (отделов и сотрудников).
